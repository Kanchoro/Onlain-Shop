package OnlainShop.Service.Impl;
...
import OnlainShop.Enum.Role;
import OnlainShop.Exception.InvalidData;
...
public class UserImpl implements UserService {
    ...
    public void logIn(String emailAdmin, String passwordAdmin) {
        ProductsDAO productsDAO = new OnlainShop.DAO.Impl.ProductsImpl();
        ProductsService products = new ProductsImpl(productsDAO);
